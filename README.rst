...
A wagtail.io based website for the famous cooking club Loorechoepf, posting recipes of their monthly events. 
...
To run the tests, enter the looreweb/tests directory and run the following commands::
